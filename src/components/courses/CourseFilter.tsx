        ...
        <div className="max-w-2xl mx-auto px-4">
          <div className="relative group">
            <input
              ...
              className="w-full px-6 py-5 pl-14 rounded-2xl border-2 border-gray-200 text-gray-900 placeholder-gray-400 focus:outline-none focus:border-french-blue focus:ring-4 focus:ring-french-blue/10 text-xl shadow-md transition-all duration-300"
            />
            <div className="absolute left-5 top-1/2 transform -translate-y-1/2">
              <svg className="w-6 h-6 text-gray-400 group-focus-within:text-french-blue transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
